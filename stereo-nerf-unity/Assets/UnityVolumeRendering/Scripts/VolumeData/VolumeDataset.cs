...
namespace UnityVolumeRendering
{
    ...
    public class VolumeDataset : ScriptableObject
    {
        ...
        // homedade
        public Texture GetRGBADataTexture()
        {
            if (dataTextureRGB == null)
                Debug.Log("creating RGBData Texture....");
                dataTextureRGB = CreateRGBATexture3D();
            return dataTextureRGB;
        ...
        private Texture3D CreateRGBATexture3D()
        {

            TextureFormat texformat = SystemInfo.SupportsTextureFormat(TextureFormat.RGBAHalf) ? TextureFormat.RGBAHalf : TextureFormat.RGBAFloat;
            Debug.Log("texture format RGB 3D: " + texformat);
            Texture3D texture = new Texture3D(dimX, dimY, dimZ, texformat, false);
            texture.wrapMode = TextureWrapMode.Clamp;
            ...
            //try
            //{
            //    cols = new Color[data_RGB.Length/4];
            //}
            //catch (OutOfMemoryException ex)
            //{
            //    cols = null;
            ...
            //            //float r = data_RGB[iData + 0];
            //            //float g = data_RGB[iData + 1];
            //            //float b = data_RGB[iData + 2];
            //            //float a = data_RGB[iData + 3];

            //            if (cols == null)
            //            {
            //                texture.SetPixel(x, y, z, data_RGB[iData]);
            //            }
            //            else
            //            {
            //                cols[iData] = data_RGB[iData];
            //            }
            //        }
            //    }
            //}
