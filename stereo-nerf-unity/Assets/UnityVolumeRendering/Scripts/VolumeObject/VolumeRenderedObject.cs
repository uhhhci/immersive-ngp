...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObject : MonoBehaviour
    {
        ...
        public SlicingPlane CreateSlicingPlane()
        {
            ...
            sliceMat.SetTexture("_DataTextRGBA", dataset.GetRGBADataTexture());
        ...
        private void UpdateMaterialProperties()
        {
            ...
            switch (renderMode)
            {
                case RenderMode.DirectVolumeRendering:
                    {
                        ...
                        meshRenderer.sharedMaterial.DisableKeyword("MODE_DVR_RGBA");
                ...
                case RenderMode.DirectVolumeRenderingRGBA:
                    {
                        meshRenderer.sharedMaterial.DisableKeyword("MODE_DVR");
                        meshRenderer.sharedMaterial.DisableKeyword("MODE_MIP");
                        meshRenderer.sharedMaterial.DisableKeyword("MODE_SURF");
                        meshRenderer.sharedMaterial.EnableKeyword("MODE_DVR_RGBA");
                        break;
                    }
            }
